...
- (void)DropDownListView:(DropDownListView *)dropdownListView Datalist:(NSMutableArray*)ArryData DataIdlist:(NSMutableArray*)IdArryData;
- (void)DropDownListViewDidCancel;
-(void)UpdateDatalist:(NSMutableArray*)ArryData UpdateDataIdlist:(NSMutableArray*)IdArryData;

@end

//@protocol DropDownListView <NSObject>
//@end
