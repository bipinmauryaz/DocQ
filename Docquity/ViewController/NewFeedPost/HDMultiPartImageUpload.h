...
@protocol AKVideoUploadFinishProtocol <NSObject>
...
@property (nonatomic,assign) NSData                *videoData;
@property (nonatomic,assign) NSData                *fileData;
@property (nonatomic)BOOL successfulUpload;
-(void)startUploadImagesToServer;
-(void)startUploadFilesToServer;


@property (nonatomic, retain) id <AKVideoUploadFinishProtocol> delegate;
