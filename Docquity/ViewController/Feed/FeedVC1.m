...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //    CGRect lblRect = [feedTitle boundingRectWithSize:(CGSize){self.view.frame.size.width-20, MAXFLOAT}
    //                                             options:NSStringDrawingUsesLineFragmentOrigin
    //                                          attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:13.0f]} context:nil];
    height += 30+padding;
...
-(void)documentButtonClicked:(id)sender event:(id)event
{
    ...
    //webvw.fullURL = @"https://staging.docquity.com/otp_verify.php?code=91&mobile=8989898989&invite=";
