...
- (void)layoutSubviews
{
    ...
    if (!_videoThumbnailImgView.hidden) {
        ...
        _documentBtn.hidden =YES;
        _documentContainerVw.hidden =YES;
        y_poistion += _videoplayBtn.frame.size.height+padding;
    ...
    if (!_documentView.hidden) {
        ...
        _openMetaDataButton.hidden = YES;
        _videoplayBtn.hidden = YES;
        y_poistion += _documentBtn.frame.size.height+padding;
...
- (void)setInfo:(NSDictionary*)feedInfo
{
    ...
    //Set user name
    _userNameLabel.text = [[NSString stringWithFormat:@"%@",[feedInfo objectForKey:@"name"]?[feedInfo objectForKey:@"name"]:@""]capitalizedString];
    ...
    //NSString*urslStrig = [ImageUrl stringByAppendingPathComponent:path];
    ...
    if ([[feedInfo valueForKey:@"file_type"]isEqualToString:@"image"])
    {
        if ([[feedInfo valueForKey:@"image_list"]count]==1) {
            ...
            //Set Feed Image
            urslStrig = feedInfo[@"file_url"];
           // urslStrig =  [ImageUrl stringByAppendingPathComponent:urslStrig];
            ...
            //firstImgUrl =  [ImageUrl stringByAppendingPathComponent:firstImgUrl];
            
            NSString* secondImgUrl = [[[feedInfo valueForKey:@"image_list"]objectAtIndex:1]valueForKey:@"multiple_file_url"];
           // secondImgUrl =  [ImageUrl stringByAppendingPathComponent:secondImgUrl];
           ...
           // firstImgUrl =  [ImageUrl stringByAppendingPathComponent:firstImgUrl];
            ...
            //thirdImgUrl =  [ImageUrl stringByAppendingPathComponent:thirdImgUrl];
          ...
          //  fourthImgUrl =  [ImageUrl stringByAppendingPathComponent:fourthImgUrl];
    ...
    if ([[feedInfo valueForKey:@"file_type"]isEqualToString:@"video"])
    {
       ...
       // urslStrig = feedInfo[@"file_url"];
        //urslStrig =  [ImageUrl stringByAppendingPathComponent:urslStrig];
        //NSLog(@"video url =%@",urslStrig);
        
        NSString*video_thumbnailUrl = feedInfo[@"video_image_url"];
       // video_thumbnailUrl  =  [ImageUrl stringByAppendingPathComponent:video_thumbnailUrl];
    ...
    if ([[feedInfo valueForKey:@"file_type"]isEqualToString:@"document"])
    {
       ...
       // urslStrig =  [ImageUrl stringByAppendingPathComponent:urslStrig];
        ...
        //document_thumbnailUrl  =  [ImageUrl stringByAppendingPathComponent:document_thumbnailUrl];
