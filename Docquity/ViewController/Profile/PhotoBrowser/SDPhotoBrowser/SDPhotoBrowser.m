...
- (void)setupToolbars
{
    ...
    saveButton.titleLabel.font = [UIFont systemFontOfSize:15 weight:UIFontWeightMedium];
    [saveButton addTarget:self action:@selector(saveImage) forControlEvents:UIControlEventTouchUpInside];
    saveButton.layer.borderColor = kBorderLayerColor;
    saveButton.layer.borderWidth = 0.9;
    ...
    doneButton.backgroundColor = [UIColor colorWithRed:0.1f green:0.1f blue:0.1f alpha:0.90f];
    doneButton.layer.cornerRadius = 2;
    doneButton.clipsToBounds = YES;
    doneButton.titleLabel.font = [UIFont systemFontOfSize:15 weight:UIFontWeightMedium];
    [doneButton addTarget:self action:@selector(closeView:) forControlEvents:UIControlEventTouchUpInside];
    doneButton.layer.borderColor = kBorderLayerColor;
    _doneButton = doneButton;
    doneButton.layer.borderWidth = 0.9;
...
- (void)closeView:(UIButton *)sender
{
  ...
  //  NSInteger currentIndex = currentImageView.tag;
    ...
    NSInteger currentIndex = _scrollView.contentOffset.x / _scrollView.bounds.size.width;
    UIImageView *currentImageView = _scrollView.subviews[currentIndex];
...
- (void)image:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo;
{
    ...
    label.bounds = CGRectMake(0, 0, 150, 70);
...
- (void)layoutSubviews
{
    ...
    _saveButton.frame = CGRectMake(10, 30, 50, 25);
    _doneButton.frame = CGRectMake(self.bounds.size.width - 60, 30, 50, 25);
}
