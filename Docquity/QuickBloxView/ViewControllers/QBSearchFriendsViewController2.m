...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section == 0){
        if(shouldShowSearchResults)
        {
            ...
            s_cell.lbl_specName.text = spcName;
        ...
        if(shouldShowSearchResults)
        {
            ...
            a_cell.lbl_assoname.text = assoName;
            ...
            NSString *assoName =  [assoArray objectAtIndex:indexPath.row][@"association_name"];
            if([assoName isKindOfClass:[NSNull class]]){
                assoName = @"";
            }
            a_cell.lbl_assoname.text = assoName;
            ...
            a_cell.lbl_assoCountry.text = [assoArray objectAtIndex:indexPath.row][@"country"];
            a_cell.img_asso.layer.borderColor = [UIColor colorWithRed:239.0/255.0 green:239.0/255.0 blue:239.0/255.0 alpha:1.0].CGColor;
            a_cell.img_asso.layer.borderWidth = 0.5;
            a_cell.img_asso.contentMode = UIViewContentModeScaleAspectFill;
            a_cell.img_asso.layer.masksToBounds = YES;
        ...
        if(shouldShowSearchResults)
        {
            ...
            u_cell.lbl_country.text = [self.filteredList objectAtIndex:indexPath.row][@"country"];
            if([[self.filteredList objectAtIndex:indexPath.row][@"country"] isEqualToString:@""]){
                u_cell.HeightConstraintCountry.constant = 0;
            }
            u_cell.lbl_association.text = [self.filteredList objectAtIndex:indexPath.row][@"institution_name"];
            ...
            u_cell.lbl_specialtity.text = spcName;
        }
        else{
            ...
            u_cell.lbl_country.text = [friendsArray objectAtIndex:indexPath.row][@"country"];
            if([[friendsArray objectAtIndex:indexPath.row][@"country"] isEqualToString:@""]){
                u_cell.HeightConstraintCountry.constant = 0;
            }
            u_cell.lbl_association.text = [friendsArray objectAtIndex:indexPath.row][@"institution_name"];
...
-(void)viewProfileWithCustId:(NSString *)custid UserJabberId:(NSString *)userJabId{
    ...
    NewProfile.userJabberId  = userJabId;
    NewProfile .customUserId =  custid;
