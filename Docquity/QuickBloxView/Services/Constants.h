 ...
 *  SearchAllSpecAssoVC
 */
static NSString *const kGoToShowAllAssoSegueIdentifier = @"goToShowAllAsso";

/**
 *  Single user Search ViewController
 */
static NSString *const kGoToSingleUserSegueIdentifier = @"goToSingleUserSearch";
#endif
