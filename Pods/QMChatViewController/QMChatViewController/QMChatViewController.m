...
- (void)didPressAccessoryButton:(UIButton *)sender {
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"Photo Library", nil)
                                                      ...
                                                      handler:^(UIAlertAction * _Nonnull __unused action) {
                                                          ...
                                                          self.pickerController.navigationBar.translucent = NO;
                                                          self.pickerController.navigationBar.barTintColor = [UIColor colorWithRed:0 green:137.0/255.0 blue:202.0/255.0 alpha:1];
                                                          self.pickerController.navigationBar.tintColor = [UIColor whiteColor];
                                                          self.pickerController.navigationBar.titleTextAttributes = @{NSForegroundColorAttributeName: [UIColor whiteColor]};
...
//        NSLog(@"UICollectionElementKindSectionFooter QM Chat");
//        QMHeaderCollectionReusableView *footerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter
...
//    headerView.headerLabel.text = @"Testing Header";
...
//
        ...
        [self setToolbarBottomConstraintValue:Keyboard.size.height
                                           animated:YES];
